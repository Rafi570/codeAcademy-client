...
export default function CourseIdDetails() {
  ...
  useEffect(() => {
    fetch(`https://codeacademy-api.vercel.app/courses/${id}`)
      .then((res) => res.json())
  ...
  const handleEnroll = async () => {
    ...
    try {
      const res = await fetch("https://codeacademy-api.vercel.app/my-course", {
        method: "POST",
  ...
  const handleReview = async (e) => {
    ...
    try {
      const res = await fetch("https://codeacademy-api.vercel.app/reviews", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
